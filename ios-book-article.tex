...
\begin{abstract}
Risk of bias (RoB) assessment of randomized clinical trials (RCTs), which are high-quality medical evidence, is vital to answer a systematic review question accurately. 
...
In this pilot annotation project, we test the feasibility of directly using the revised Cochrane risk of bias tool for randomized trials for developing an RoB annotated corpus. 
