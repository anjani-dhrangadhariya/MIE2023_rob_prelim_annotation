...
However, to date, we neither know any publicly available hand-labelled corpus for human RCTs using the widely used revised Cochrane's RoB 2.0 tool nor any corpus annotation guidelines that could help to annotate one.~\cite{sterne2019rob,lansbury2020co}
...
1) To test whether revised Cochrane RoB 2.0 assessment guidelines could be used as RoB corpus annotation guidelines to develop a corpus that could be used for training supervised ML models.
